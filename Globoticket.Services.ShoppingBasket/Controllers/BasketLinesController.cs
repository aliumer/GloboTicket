...
namespace Globoticket.Services.ShoppingBasket.Controllers
{
    ...
    public class BasketLinesController : ControllerBase
    {
        ...
        public BasketLinesController(IBasketRepository basketRepository, IBasketLinesRepository basketLinesRepository, IEventRepository eventRepository, IEventCatalogService eventCatalogService, IMapper mapper, IBasketChangeEventRepository basketChangeEventRepository)
        {
            this.basketRepository = basketRepository ?? throw new ArgumentNullException(nameof(basketRepository));
            this.basketLinesRepository = basketLinesRepository ?? throw new ArgumentNullException(nameof(basketLinesRepository));
